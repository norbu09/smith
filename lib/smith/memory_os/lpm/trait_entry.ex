defmodule Smith.MemoryOS.LPM.TraitEntry do
  use Ash.Resource,
  ...
  relationships do
    belongs_to :object_persona, Smith.MemoryOS.LPM.ObjectPersona do
      attribute_writable? true
      allow_nil? true
    end

    belongs_to :agent_persona, Smith.MemoryOS.LPM.AgentPersona do
      attribute_writable? true
      allow_nil? true
    end
  end
