defmodule Smith.MemoryOS.Configuration do
  use Ash.Resource,
  ...
  def get_agent_config(agent_id) do
    case Smith.MemoryOS.Configuration.get_or_create(agent_id, "default", %{}) do
      ...
      {:error, _} ->
        ...
        %{
          agent_id: agent_id,
          stm_max_pages: Application.get_env(:smith, :memory_os)[:stm_max_pages],
          mtm_max_segments: Application.get_env(:smith, :memory_os)[:mtm_max_segments],
          lpm_max_entries: Application.get_env(:smith, :memory_os)[:lpm_max_entries],
          system_memory_max_entries:
            Application.get_env(:smith, :memory_os)[:system_memory_max_entries],
          embedding_model: Application.get_env(:smith, :memory_os)[:embedding_model],
          embedding_dimensions: Application.get_env(:smith, :memory_os)[:embedding_dimensions],
          heat_decay_coefficient:
            Application.get_env(:smith, :memory_os)[:heat_decay_coefficient],
          heat_alpha: Application.get_env(:smith, :memory_os)[:heat_alpha],
          heat_beta: Application.get_env(:smith, :memory_os)[:heat_beta],
          heat_gamma: Application.get_env(:smith, :memory_os)[:heat_gamma]
        }
    end
  end
