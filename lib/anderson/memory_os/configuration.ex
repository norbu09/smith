    ...
    create :get_or_create do
      ...
      change fn changeset, _context ->
        ...
        Enum.reduce(settings, changeset, fn {key, value}, acc ->
          ...
          valid_config_keys = [:agent_id, :stm_max_pages, :mtm_max_segments, :lpm_max_entries, 
                             :system_memory_max_entries, :embedding_model, :embedding_dimensions,
                             :heat_decay_coefficient, :heat_alpha, :heat_beta, :heat_gamma]
    ...
    case Anderson.MemoryOS.Configuration.get_or_create(agent_id, "default", %{}) do
      ...
      {:error, _} -> 
        ...
        %{
          ...
          system_memory_max_entries: Application.get_env(:anderson, :memory_os)[:system_memory_max_entries],
          ...
          heat_decay_coefficient: Application.get_env(:anderson, :memory_os)[:heat_decay_coefficient],
