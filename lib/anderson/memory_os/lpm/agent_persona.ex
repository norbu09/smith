defmodule Anderson.MemoryOS.LPM.AgentPersona do
  use Ash.Resource,
  ...
  actions do
    ...
    update :add_trait do
      ...
      change fn changeset, _context ->
        ...
        case Anderson.MemoryOS.LPM.TraitEntry.create(trait_params) do
          {:ok, _trait} -> changeset
    ...
    update :update_profile do
      ...
      change fn changeset, _ ->
        ...
        updated_profile = Map.merge(current_profile, Ash.Changeset.get_argument(changeset, :profile_updates))
