defmodule Anderson.MemoryOS.LPM.ObjectPersona do
  use Ash.Resource,
  ...
  actions do
    ...
    update :add_knowledge do
      ...
      change fn changeset, _context ->
        ...
        case Anderson.MemoryOS.LPM.KnowledgeBaseEntry.create(knowledge_attrs) do
          {:ok, _entry} -> changeset
    ...
    update :add_trait do
      ...
      change fn changeset, _context ->
        ...
        case Anderson.MemoryOS.LPM.TraitEntry.create(trait_attrs) do
          {:ok, _entry} -> changeset
          {:error, error} -> Ash.Changeset.add_error(changeset, error)
        end
      end
  ...
  relationships do
    ...
    has_many :knowledge_base_entries, Anderson.MemoryOS.LPM.KnowledgeBaseEntry do
      destination_attribute :object_persona_id
    end

    # For trait entries
    has_many :trait_entries, Anderson.MemoryOS.LPM.TraitEntry do
      destination_attribute :object_persona_id
    end
  end
